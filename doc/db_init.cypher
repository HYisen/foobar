...
CREATE (account0:Account {username:"alexhyisen",password:"8964"})
...
CREATE (account1:Account {username:"xijinping",password:"666"})
...
CREATE (account2:Account {username:"realDT",password:"666"})
...
CREATE (account3:Account {username:"zeminJ",password:"123456"})
...
CREATE (account4:Account {username:"abe",password:"aaaa"})
